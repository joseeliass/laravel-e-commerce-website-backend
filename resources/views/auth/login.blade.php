        ...
        <form action = "{{route('login-user')}}" method = "post">
          ...
          @csrf
              ...
              <div class="form-group">
                  ...
                  <input id = "email" type="text" name="name" placeholder = "enter your name" class= "form-control" value = "{{old('name')}}">
                  <span class="text-danger">@error('name') {{$message}} @enderror</span>
              </div>
              
              <div class="form-group">
                  <label for="email">enter your email: </label>
                  <input id = "email" type="text" name="email" placeholder = "enter your email" class= "form-control" value = "{{old('email')}}">
              ...
              <div class="form-group">
                  ...
                  <span class="text-danger">@error('password') {{$message}} @enderror</span>
                    ...
                    <br>
              <div class="form-group">
                  <button id = "submit" class="btn btn-block btn-primary" type="submit">Log in</button>
                  <br>
                  <span> don't have an account?<a href="http://127.0.0.1:8000/registration">Create here</a></span>
              </div>
          </form>
      </div>
    </div>
